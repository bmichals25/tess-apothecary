...
/* ─── Custom Blend & Consultation Products (non-browseable, for cart only) ─── */
export const customBlendProducts = [
  {
    slug: "custom-blend-2oz",
    name: "Custom Blend (2oz Sample)",
    price: 24,
    category: "Custom",
    tagline: "A one-of-a-kind herbal blend crafted just for you",
    description: "Your custom herbal tea blend — 2oz sample size. Tess will review your profile and hand-select herbs tailored to your needs.",
    ingredients: ["Custom selection based on your profile"],
    ingredientDetails: "Custom selection — details provided via email before shipping",
    caffeine: "Based on your preference",
    waterTemp: "Included with your blend card",
    steepTime: "Included with your blend card",
    bestWith: "Your daily ritual",
    accentColor: "#D4A843",
    gradientFrom: "#1A1A1A",
    gradientTo: "#D4A843",
    iconEmoji: "\u2728",
    image: "/images/products/mockup-full-collection.jpg",
  },
  {
    slug: "custom-blend-4oz",
    name: "Custom Blend (4oz Regular)",
    price: 38,
    category: "Custom",
    tagline: "A one-of-a-kind herbal blend crafted just for you",
    description: "Your custom herbal tea blend — 4oz regular size. Tess will review your profile and hand-select herbs tailored to your needs.",
    ingredients: ["Custom selection based on your profile"],
    ingredientDetails: "Custom selection — details provided via email before shipping",
    caffeine: "Based on your preference",
    waterTemp: "Included with your blend card",
  ...
  {
    slug: "custom-blend-8oz",
    name: "Custom Blend (8oz Apothecary Size)",
    price: 62,
    category: "Custom",
    tagline: "A one-of-a-kind herbal blend crafted just for you",
    description: "Your custom herbal tea blend — 8oz apothecary size. Tess will review your profile and hand-select herbs tailored to your needs.",
    ingredients: ["Custom selection based on your profile"],
    ingredientDetails: "Custom selection — details provided via email before shipping",
    caffeine: "Based on your preference",
    waterTemp: "Included with your blend card",
  ...
  },
  {
    ...
    name: "Quick Consult (15 min)",
    price: 35,
    category: "Consultation",
    tagline: "A focused herbology session on one specific concern",
    description: "A 15-minute one-on-one consultation with an herbology expert. Video or phone call focused on one specific wellness concern.",
    ingredients: [],
    ingredientDetails: "N/A — consultation service",
    caffeine: "N/A",
    waterTemp: "N/A",
    steepTime: "15 minutes",
    bestWith: "An open mind",
    accentColor: "#2D4A3E",
    gradientFrom: "#1A1A1A",
    gradientTo: "#2D4A3E",
    iconEmoji: "\u260E",
  ...
  },
  {
    ...
    name: "Full Consultation (45 min)",
    price: 85,
    category: "Consultation",
    tagline: "Comprehensive wellness review + custom blend recommendation",
    description: "A 45-minute comprehensive wellness review via video call. Includes a full assessment and one custom blend (4oz).",
    ingredients: [],
    ingredientDetails: "N/A — consultation service (includes 1 custom blend)",
    caffeine: "N/A",
    waterTemp: "N/A",
    steepTime: "45 minutes",
    bestWith: "A quiet space and a cup of tea",
    accentColor: "#2D4A3E",
    gradientFrom: "#1A1A1A",
    gradientTo: "#2D4A3E",
    iconEmoji: "\u260E",
  ...
  },
  {
    ...
    name: "The Deep Dive (90 min)",
    price: 150,
    category: "Consultation",
    tagline: "Full health history, herbal protocol, ongoing support",
    description: "A 90-minute deep-dive consultation. Includes two custom blends (4oz each), a written herbal protocol, and 2 weeks of email follow-up.",
    ingredients: [],
    ingredientDetails: "N/A — consultation service (includes 2 custom blends + written protocol)",
    caffeine: "N/A",
    waterTemp: "N/A",
    steepTime: "90 minutes",
    bestWith: "Time, intention, and a willingness to go deep",
    accentColor: "#2D4A3E",
    gradientFrom: "#1A1A1A",
    gradientTo: "#2D4A3E",
    iconEmoji: "\u260E",
